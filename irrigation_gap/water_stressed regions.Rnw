...
Define small-scale farms as the smallest 40\% of farms in each country, located in LMICs, and located in areas with low HDI (HDI <= 0.549).
...
Calculate global totals for irrigation gap by non/small-scale farm and water scarce region.
...
Calculate country level totals for irrigation gap by non/small-scale farm and water scarce region.
